...
function MultiSelectBar({
  ...
  return (
    <div className="multi-select-bar" onClick={(e) => e.stopPropagation()}>
      ...
      <button className="multi-action-btn" onClick={(e) => { e.stopPropagation(); onDownload(); }}>
      ...
      <button className="multi-action-btn" onClick={(e) => { e.stopPropagation(); onCompress(); }}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      ...
      <button className="multi-action-btn danger" onClick={(e) => { e.stopPropagation(); onDelete(); }}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      ...
      <button className="multi-action-btn" onClick={onClear}>
        취소
      </button>
    </div>
  )
