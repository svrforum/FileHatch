  ...
  const renderFileTypeIcon = (icon: string) => {
    switch (icon) {
      ...
      case 'hwp':
        return (
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2Z" stroke="#1B7AE3" strokeWidth="2"/>
            <path d="M14 2V8H20" stroke="#1B7AE3" strokeWidth="2"/>
            <text x="12" y="17" textAnchor="middle" fontSize="7" fill="#1B7AE3" fontWeight="bold">한</text>
          </svg>
        )
      default:
        return null
  ...
  return (
    ...
    >
      ...
      {contextMenu.type === 'background' ? (
        ...
        <>
          {!isReadonly && !contextMenu.file.isDir && isEditableFile(contextMenu.file) && (
          ...
          {!isReadonly && !contextMenu.file.isDir && onlyOfficeAvailable && isOnlyOfficeSupported(contextMenu.file.extension) && (
          ...
          {/* Star/Favorite button - works for both files and folders */}
          {onToggleStar && (
