...
const docTemplate = `{
    ...
    "paths": {
        "/admin/users/import-jobs": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Unique submission key",
                    ...
                    {
                        "type": "file",
                        "description": "Same CSV file submitted for validation",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Validated SHA-256 digest",
                        "name": "digest",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Validated password policy revision",
                        "name": "policyRevision",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/admin/users/import-jobs/{id}/result": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/users/import/validate": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "UTF-8 CSV file (maximum 5 MB)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.userImportValidation"
                        }
                    }
                }
            }
        ...
        "/audit/logs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by category (file, admin, user, activity, access)",
                        "name": "category",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search username, IP, event type, or target resource",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/files/compress-stream": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Comma-separated list of paths to compress",
                        "name": "paths",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Output zip file name (without .zip extension)",
                        "name": "outputName",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "SSE stream with progress updates",
                        "schema": {
                            "$ref": "#/definitions/handlers.CompressionProgress"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/s/{token}/file": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "File path within the shared folder",
                        "name": "filepath",
                        "in": "query",
                        "required": true
                    },
        ...
        "/s/{token}/list": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Subpath within the shared folder",
                        "name": "subpath",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "handlers.CompressionProgress": {
            ...
            "properties": {
                ...
                "currentFile": {
                    "description": "Current file being compressed",
                    "type": "string"
                },
                "error": {
                ...
                "outputSize": {
                    "description": "Final compressed file size",
                    "type": "integer"
                },
                "processedFiles": {
                ...
                "totalBytes": {
                    "description": "Total bytes to compress",
                    "type": "integer"
                },
                "totalFiles": {
        ...
        "handlers.userImportValidation": {
            ...
            "properties": {
                ...
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.userImportRowResult"
                    }
                },
                "summary": {
                    "$ref": "#/definitions/handlers.userImportSummary"
                },
                "totalRows": {
                    "type": "integer"
                },
